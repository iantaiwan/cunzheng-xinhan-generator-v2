...
測試涵蓋 20／200／201 字分頁邊界、強制換行、Unicode grapheme、郵遞區號、整數範圍及 HTML escaping。Pull request 也會透過 GitHub Actions 自動執行語法檢查與測試。
